...
//W25Q24 8M字节 分成 128个块 16个扇区 16个页 一页256个字节

//修改此宏可以改变驱动方式 硬件 软件
#define W25Qxx_USE  W25Qxx_USE_SW_SPI 
...
//#define W25Qxx_WriteEnable() W25Qxx_IO2(1)
//#define W25Qxx_WriteDisable() W25Qxx_IO2(0)
...
//extern W25Qxx_InitTypeDef W25Qxx_handler1;
