...
//    MYDMA_Config2(DMA1_Channel2,(u32)&SPI1->DR,0,0);
    ...
    DMA1_Channel3->CCR = 0x1090;//001000010010000
    DMA1_Channel3->CMAR = 0;
    DMA1_Channel3->CNDTR = 256;
    DMA1_Channel3->CPAR = (u32)&SPI1->DR;
    
    DMA1_Channel2->CCR = 0x1080;//001000010010000
...
//  }
    ...
    DMA1_Channel3->CNDTR = (uint16_t)NumByteToWrite;//传输数量
    DMA1_Channel3->CMAR  = (uint32_t)pBuffer;//内存地址
    DMA1_Channel3->CCR |= 0x01;
...
//  }
    ...
    DMA1_Channel2->CNDTR = (uint16_t)NumByteToRead;//传输数量
    DMA1_Channel2->CMAR  = (uint32_t)pBuffer;//内存地址
    ...
    DMA1_Channel3->CCR &= ~0x01;
    DMA1_Channel3->CNDTR = (uint16_t)NumByteToRead;//传输数量
    DMA1_Channel3->CMAR  = (uint32_t)pBuffer;//内存地址
    //DMA_Cmd(DMA1_Channel3, ENABLE);
    DMA1_Channel3->CCR |= 0x01;
    SPI1->CR2 |= 0X02;
